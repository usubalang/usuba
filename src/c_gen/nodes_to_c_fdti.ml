...
let rec expr_to_c (lift_env : int VarHashtbl.t) (conf : Config.config)
...
(* TODO: this 64 and 32 shouldn't be hardcoded *)
let expr_to_c_ret (lift_env : int VarHashtbl.t) (conf : Config.config)
    (env : (string, string) Hashtbl.t) (env_var : typ Ident.Hashtbl.t)
...
let fun_call_to_c (lift_env : int VarHashtbl.t) (conf : Config.config)
    (env : (string, string) Hashtbl.t) (env_var : typ Ident.Hashtbl.t)
