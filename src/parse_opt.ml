...
let generate_conf ?(anon_fun = fun _ -> ()) parser =
  ...
  let dump_steps_base_file = ref "tmp" in
  ...
  parser speclist anon_fun usage_msg;
  ...
  Config.
    {
      ...
      dump_steps_dir = !dump_steps_dir;
      dump_steps_base_file = !dump_steps_base_file;
