...
let test_vslice () =
  ...
  assert (fold_expr env_var (parse_expr "x * 0xff:u<V>8") = parse_expr "x * 0xff:u<V>8");
  assert (fold_expr env_var (parse_expr "0xff:u<V>8 * x") = parse_expr "0xff:u<V>8 * x");
  ...
  assert (fold_expr env_var (parse_expr "2:u<V>8 * 3:u<V>8") = parse_expr "6:u<V>8");

  (* Addition *)
  assert (fold_expr env_var (parse_expr "x + y") = parse_expr "x + y");
  assert (fold_expr env_var (parse_expr "x + 0:u<V>8") = parse_expr "x");
  assert (fold_expr env_var (parse_expr "0:u<V>8 + x") = parse_expr "x");
  assert (fold_expr env_var (parse_expr "0:u<V>8 + 5:u<V>8") = parse_expr "5:u<V>8");

  (* Subtraction *)
  assert (fold_expr env_var (parse_expr "x - y") = parse_expr "x - y");
  assert (fold_expr env_var (parse_expr "x - 0:u<V>8") = parse_expr "x");
  assert (fold_expr env_var (parse_expr "0:u<V>8 - x") = parse_expr "0:u<V>8 - x");
  assert (fold_expr env_var (parse_expr "11:u<V>8 - 5:u<V>8") = parse_expr "6:u<V>8");

  (* Division *)
  assert (fold_expr env_var (parse_expr "x / y") = parse_expr "x / y");
  assert (fold_expr env_var (parse_expr "x / 1:u<V>8") = parse_expr "x");
  assert (fold_expr env_var (parse_expr "0:u<V>8 / x") = parse_expr "0:u<V>8");
  assert (fold_expr env_var (parse_expr "11:u<V>8 / 5:u<V>8") = parse_expr "2:u<V>8");

  (* Modulo *)
  assert (fold_expr env_var (parse_expr "x % y") = parse_expr "x % y");
  assert (fold_expr env_var (parse_expr "x % 1:u<V>8") = parse_expr "0:u<V>8");
  assert (fold_expr env_var (parse_expr "0:u<V>8 / x") = parse_expr "0:u<V>8");
  assert (fold_expr env_var (parse_expr "11:u<V>8 % 5:u<V>8") = parse_expr "1:u<V>8");
  ...
  assert (fold_expr env_var (parse_expr "x & 0:u<V>8") = parse_expr "0:u<V>8");
  assert (fold_expr env_var (parse_expr "0:u<V>8 & x") = parse_expr "0:u<V>8");
  assert (fold_expr env_var (parse_expr "x & 1:u<V>8") = parse_expr "x & 1:u<V>8");
  ...
  (* Or *)
  assert (fold_expr env_var (parse_expr "x | y") = parse_expr "x | y");
  assert (fold_expr env_var (parse_expr "x | 0xff:u<V>8") = parse_expr "0xff:u<V>8");
  assert (fold_expr env_var (parse_expr "0xff:u<V>8 | x") = parse_expr "0xff:u<V>8");
  assert (fold_expr env_var (parse_expr "x | 0:u<V>8") = parse_expr "x");
  assert (fold_expr env_var (parse_expr "0:u<V>8 | x") = parse_expr "x");
  assert (fold_expr env_var (parse_expr "x | 1:u<V>8") = parse_expr "x | 1:u<V>8");
  assert (fold_expr env_var (parse_expr "1:u<V>8 | x") = parse_expr "1:u<V>8 | x");
  ...
  assert (fold_expr env_var (parse_expr "~(0x0:u<V>8)") = parse_expr "0xff:u<V>8");
