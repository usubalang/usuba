...
let main a_stream b_stream = 
    ...
    try
        ...
        let (retc1,retc2,retc3,retc4,retd1,retd2,retd3,retd4) = (if c1' then 128 else 0)lor(if c2' then 64 else 0)lor(if c3' then 32 else 0)lor(if c4' then 16 else 0)lor(if d1' then 8 else 0)lor(if d2' then 4 else 0)lor(if d3' then 2 else 0)lor(if d4' then 1 else 0)
