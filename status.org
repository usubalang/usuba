...
** DONE Reorganize code (permutations and array should be independant from usuba1)
   CLOSED: [2017-03-13 lun. 11:53]
** TODO Correct behavior of fby
   for now, the state of a fby is global for the program. it shouldn't be.
