...
void des__ (unsigned long plaintext[64],unsigned long key[64],unsigned long ciphered[64]) {
  ...
  plaintext[58] = (des_single__15_sbox_out__0__1) ^ (plaintext[58]);
  plaintext[60] = (des_single__15_sbox_out__0__2) ^ (plaintext[60]);
  plaintext[12] = (des_single__15_sbox_out__0__3) ^ (plaintext[12]);
  plaintext[14] = (des_single__15_sbox_out__0__4) ^ (plaintext[14]);
  ...
  plaintext[26] = (des_single__15_sbox_out__1__1) ^ (plaintext[26]);
  plaintext[38] = (des_single__15_sbox_out__1__2) ^ (plaintext[38]);
  plaintext[48] = (des_single__15_sbox_out__1__3) ^ (plaintext[48]);
  plaintext[52] = (des_single__15_sbox_out__1__4) ^ (plaintext[52]);
  ...
  plaintext[4] = (des_single__15_sbox_out__2__1) ^ (plaintext[4]);
  plaintext[2] = (des_single__15_sbox_out__2__2) ^ (plaintext[2]);
  plaintext[22] = (des_single__15_sbox_out__2__3) ^ (plaintext[22]);
  plaintext[16] = (des_single__15_sbox_out__2__4) ^ (plaintext[16]);
  ...
  plaintext[54] = (des_single__15_sbox_out__3__1) ^ (plaintext[54]);
  plaintext[36] = (des_single__15_sbox_out__3__2) ^ (plaintext[36]);
  plaintext[50] = (des_single__15_sbox_out__3__3) ^ (plaintext[50]);
  plaintext[56] = (des_single__15_sbox_out__3__4) ^ (plaintext[56]);
  ...
  plaintext[0] = (des_single__15_sbox_out__4__1) ^ (plaintext[0]);
  plaintext[18] = (des_single__15_sbox_out__4__2) ^ (plaintext[18]);
  plaintext[62] = (des_single__15_sbox_out__4__3) ^ (plaintext[62]);
  plaintext[40] = (des_single__15_sbox_out__4__4) ^ (plaintext[40]);
  ...
  plaintext[32] = (des_single__15_sbox_out__5__1) ^ (plaintext[32]);
  plaintext[30] = (des_single__15_sbox_out__5__2) ^ (plaintext[30]);
  plaintext[42] = (des_single__15_sbox_out__5__3) ^ (plaintext[42]);
  plaintext[44] = (des_single__15_sbox_out__5__4) ^ (plaintext[44]);
  ...
  plaintext[6] = (des_single__15_sbox_out__6__1) ^ (plaintext[6]);
  plaintext[34] = (des_single__15_sbox_out__6__2) ^ (plaintext[34]);
  plaintext[20] = (des_single__15_sbox_out__6__3) ^ (plaintext[20]);
  plaintext[8] = (des_single__15_sbox_out__6__4) ^ (plaintext[8]);
  ...
  plaintext[24] = (des_single__15_sbox_out__7__1) ^ (plaintext[24]);
  plaintext[46] = (des_single__15_sbox_out__7__2) ^ (plaintext[46]);
  plaintext[10] = (des_single__15_sbox_out__7__3) ^ (plaintext[10]);
  plaintext[28] = (des_single__15_sbox_out__7__4) ^ (plaintext[28]);
  ciphered[0] = plaintext[1];
  ciphered[1] = plaintext[0];
  ciphered[2] = plaintext[3];
  ciphered[3] = plaintext[2];
  ciphered[4] = plaintext[5];
  ciphered[5] = plaintext[4];
  ciphered[6] = plaintext[7];
  ciphered[7] = plaintext[6];
  ciphered[8] = plaintext[9];
  ciphered[9] = plaintext[8];
  ciphered[10] = plaintext[11];
  ciphered[11] = plaintext[10];
  ciphered[12] = plaintext[13];
  ciphered[13] = plaintext[12];
  ciphered[14] = plaintext[15];
  ciphered[15] = plaintext[14];
  ciphered[16] = plaintext[17];
  ciphered[17] = plaintext[16];
  ciphered[18] = plaintext[19];
  ciphered[19] = plaintext[18];
  ciphered[20] = plaintext[21];
  ciphered[21] = plaintext[20];
  ciphered[22] = plaintext[23];
  ciphered[23] = plaintext[22];
  ciphered[24] = plaintext[25];
  ciphered[25] = plaintext[24];
  ciphered[26] = plaintext[27];
  ciphered[27] = plaintext[26];
  ciphered[28] = plaintext[29];
  ciphered[29] = plaintext[28];
  ciphered[30] = plaintext[31];
  ciphered[31] = plaintext[30];
  ciphered[32] = plaintext[33];
  ciphered[33] = plaintext[32];
  ciphered[34] = plaintext[35];
  ciphered[35] = plaintext[34];
  ciphered[36] = plaintext[37];
  ciphered[37] = plaintext[36];
  ciphered[38] = plaintext[39];
  ciphered[39] = plaintext[38];
  ciphered[40] = plaintext[41];
  ciphered[41] = plaintext[40];
  ciphered[42] = plaintext[43];
  ciphered[43] = plaintext[42];
  ciphered[44] = plaintext[45];
  ciphered[45] = plaintext[44];
  ciphered[46] = plaintext[47];
  ciphered[47] = plaintext[46];
  ciphered[48] = plaintext[49];
  ciphered[49] = plaintext[48];
  ciphered[50] = plaintext[51];
  ciphered[51] = plaintext[50];
  ciphered[52] = plaintext[53];
  ciphered[53] = plaintext[52];
  ciphered[54] = plaintext[55];
  ciphered[55] = plaintext[54];
  ciphered[56] = plaintext[57];
  ciphered[57] = plaintext[56];
  ciphered[58] = plaintext[59];
  ciphered[59] = plaintext[58];
  ciphered[60] = plaintext[61];
  ciphered[61] = plaintext[60];
  ciphered[62] = plaintext[63];
  ciphered[63] = plaintext[62];
}
