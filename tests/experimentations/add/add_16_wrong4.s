...
# mark_description "nline-max-total-size=10000 -O3 -funroll-loops -unroll-agressive -S -o add_16_wrong4.s";
	.file "add_16_wrong4.c"
	.text
..TXTST0:
# -- Begin  main
	.text
...
..L2:
	...
	.cfi_offset 6, -16
        ...
        pushq     %rbx                                          #72.13
        subq      $600, %rsp                                    #72.13
        movl      $10330110, %esi                               #72.13
        movl      $3, %edi                                      #72.13
        call      __intel_new_feature_proc_init                 #72.13
...
..B1.156:                       # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #72.13
        movl      $.L_2__STRING.0, %edi                         #75.13
        movl      $.L_2__STRING.1, %esi                         #75.13
        orl       $32832, (%rsp)                                #72.13
        vldmxcsr  (%rsp)                                        #72.13
...
..B1.4:                         # Preds ..B1.3
                                # Execution count [1.00e+00]
        movl      $32, %edi                                     #82.30
        movl      $256000000, %esi                              #82.30
..___tag_value_main.11:
#       aligned_alloc(size_t, size_t)
        call      aligned_alloc                                 #82.30
...
..B1.9:                         # Preds ..B1.8
                                # Execution count [1.00e+00]
        vmovd     %eax, %xmm0                                   #84.8
        vmovd     %r15d, %xmm1                                  #84.8
        vmovd     %r13d, %xmm2                                  #84.8
        vmovd     %r14d, %xmm3                                  #84.8
        vpunpcklqdq %xmm1, %xmm0, %xmm4                         #84.8
        vpunpcklqdq %xmm3, %xmm2, %xmm5                         #84.8
        vshufps   $136, %xmm5, %xmm4, %xmm6                     #84.8
        vmovups   %xmm6, 496(%rsp)                              #84.8[spill]
#       rand(void)
        call      rand                                          #85.22
                                # LOE rbx r12 eax
..B1.163:                       # Preds ..B1.9
...
..B1.13:                        # Preds ..B1.12
        ...
        vmovups   %xmm6, 480(%rsp)                              #85.8[spill]
#       rand(void)
        call      rand                                          #86.22
                                # LOE rbx r12 eax
..B1.167:                       # Preds ..B1.13
...
..B1.17:                        # Preds ..B1.16
        ...
        vmovups   %xmm6, 368(%rsp)                              #86.8[spill]
#       rand(void)
        call      rand                                          #87.22
                                # LOE rbx r12 eax
..B1.171:                       # Preds ..B1.17
...
..B1.25:                        # Preds ..B1.24
        ...
        vmovups   %xmm6, 464(%rsp)                              #88.8[spill]
#       rand(void)
        call      rand                                          #89.22
                                # LOE rbx r12 eax
..B1.179:                       # Preds ..B1.25
...
..B1.29:                        # Preds ..B1.28
        ...
        vmovups   %xmm6, 432(%rsp)                              #89.8[spill]
#       rand(void)
        call      rand                                          #90.22
                                # LOE rbx r12 eax
..B1.183:                       # Preds ..B1.29
...
..B1.33:                        # Preds ..B1.32
        ...
        vmovups   %xmm6, 384(%rsp)                              #90.8[spill]
#       rand(void)
        call      rand                                          #91.22
                                # LOE rbx r12 eax
..B1.187:                       # Preds ..B1.33
...
..B1.37:                        # Preds ..B1.36
        ...
        vmovups   %xmm6, 416(%rsp)                              #91.8[spill]
#       rand(void)
        call      rand                                          #92.22
                                # LOE rbx r12 eax
..B1.191:                       # Preds ..B1.37
...
..B1.41:                        # Preds ..B1.40
        ...
        vmovups   %xmm6, 352(%rsp)                              #92.8[spill]
#       rand(void)
        call      rand                                          #93.23
                                # LOE rbx r12 eax
..B1.195:                       # Preds ..B1.41
...
..B1.45:                        # Preds ..B1.44
                                # Execution count [1.00e+00]
        vmovd     %eax, %xmm0                                   #93.9
        vmovd     %r15d, %xmm1                                  #93.9
        vmovd     %r13d, %xmm2                                  #93.9
        vmovd     %r14d, %xmm3                                  #93.9
        vpunpcklqdq %xmm1, %xmm0, %xmm4                         #93.9
        vpunpcklqdq %xmm3, %xmm2, %xmm5                         #93.9
        vshufps   $136, %xmm5, %xmm4, %xmm6                     #93.9
        vmovups   %xmm6, 336(%rsp)                              #93.9[spill]
#       rand(void)
        call      rand                                          #94.23
                                # LOE rbx r12 eax
..B1.199:                       # Preds ..B1.45
...
..B1.49:                        # Preds ..B1.48
        ...
        vmovups   %xmm6, 448(%rsp)                              #94.9[spill]
#       rand(void)
        call      rand                                          #95.23
                                # LOE rbx r12 eax
..B1.203:                       # Preds ..B1.49
...
..B1.53:                        # Preds ..B1.52
        ...
        vmovups   %xmm6, 304(%rsp)                              #95.9[spill]
#       rand(void)
        call      rand                                          #96.23
                                # LOE rbx r12 eax
..B1.207:                       # Preds ..B1.53
...
..B1.61:                        # Preds ..B1.60
        ...
        vmovups   %xmm6, 64(%rsp)                               #97.9[spill]
#       rand(void)
        call      rand                                          #98.23
                                # LOE rbx r12 eax
..B1.215:                       # Preds ..B1.61
...
..B1.65:                        # Preds ..B1.64
        ...
        vmovups   %xmm6, 96(%rsp)                               #98.9[spill]
#       rand(void)
        call      rand                                          #99.23
                                # LOE rbx r12 eax
..B1.219:                       # Preds ..B1.65
...
..B1.69:                        # Preds ..B1.68
        ...
        vmovups   %xmm6, 160(%rsp)                              #99.9[spill]
#       rand(void)
        call      rand                                          #101.22
                                # LOE rbx r12 eax
..B1.223:                       # Preds ..B1.69
                                # Execution count [1.00e+00]
        movl      %eax, %r14d                                   #101.22
                                # LOE rbx r12 r14d
..B1.70:                        # Preds ..B1.223
                                # Execution count [1.00e+00]
#       rand(void)
...
..B1.73:                        # Preds ..B1.72
                                # Execution count [1.00e+00]
        vmovd     %eax, %xmm0                                   #101.8
        vmovd     %r15d, %xmm1                                  #101.8
        vmovd     %r13d, %xmm2                                  #101.8
        vmovd     %r14d, %xmm3                                  #101.8
        vpunpcklqdq %xmm1, %xmm0, %xmm4                         #101.8
        vpunpcklqdq %xmm3, %xmm2, %xmm5                         #101.8
        vshufps   $136, %xmm5, %xmm4, %xmm6                     #101.8
        vmovups   %xmm6, 16(%rsp)                               #101.8[spill]
#       rand(void)
        call      rand                                          #102.22
                                # LOE rbx r12 eax
..B1.227:                       # Preds ..B1.73
...
..B1.85:                        # Preds ..B1.84
        ...
        vmovups   %xmm6, 80(%rsp)                               #104.8[spill]
#       rand(void)
        call      rand                                          #105.22
                                # LOE rbx r12 eax
..B1.239:                       # Preds ..B1.85
...
..B1.109:                       # Preds ..B1.108
                                # Execution count [1.00e+00]
        vmovd     %eax, %xmm0                                   #110.9
        vmovd     %r15d, %xmm1                                  #110.9
        vmovd     %r13d, %xmm2                                  #110.9
        vmovd     %r14d, %xmm3                                  #110.9
        vpunpcklqdq %xmm1, %xmm0, %xmm4                         #110.9
        vpunpcklqdq %xmm3, %xmm2, %xmm5                         #110.9
        vshufps   $136, %xmm5, %xmm4, %xmm6                     #110.9
        vmovups   %xmm6, 208(%rsp)                              #110.9[spill]
#       rand(void)
        call      rand                                          #111.23
                                # LOE rbx r12 eax
..B1.263:                       # Preds ..B1.109
...
..B1.133:                       # Preds ..B1.286
        ...
        vmovd     %edx, %xmm0                                   #116.9
        vmovd     %r13d, %xmm1                                  #116.9
        vmovd     %r14d, %xmm2                                  #116.9
        vmovd     %r15d, %xmm3                                  #116.9
        vmovups   496(%rsp), %xmm8                              #120.17[spill]
        xorl      %eax, %eax                                    #118.3
        vpunpcklqdq %xmm1, %xmm0, %xmm4                         #116.9
        vpunpcklqdq %xmm3, %xmm2, %xmm5                         #116.9
        vxorps    480(%rsp), %xmm8, %xmm7                       #120.17[spill]
        vshufps   $136, %xmm5, %xmm4, %xmm6                     #116.9
        vxorps    %xmm8, %xmm7, %xmm0                           #120.17
        vmovups   %xmm6, (%rsp)                                 #116.9[spill]
                                # LOE rbx r12 eax xmm0
..B1.134:                       # Preds ..B1.134 ..B1.133
                                # Execution count [2.50e+00]
        lea       (%rax,%rax), %edx                             #120.5
        incl      %eax                                          #118.3
        shlq      $4, %rdx                                      #120.5
        vmovups   %xmm0, (%rbx,%rdx)                            #120.5
        vmovups   %xmm0, 16(%rbx,%rdx)                          #120.5
        cmpl      $8000000, %eax                                #118.3
        jb        ..B1.134      # Prob 63%                      #118.3
                                # LOE rbx r12 eax xmm0
..B1.135:                       # Preds ..B1.134
                                # Execution count [1.00e+00]
        movq      %rbx, %rdi                                    #122.3
        movl      $16, %esi                                     #122.3
        movl      $16000000, %edx                               #122.3
        movq      %r12, %rcx                                    #122.3
...
..B1.139:                       # Preds ..B1.287
                                # Execution count [9.00e-01]
        vmovups   496(%rsp), %xmm14                             #128.5[spill]
        vmovups   480(%rsp), %xmm13                             #128.5[spill]
        vmovups   368(%rsp), %xmm12                             #128.5[spill]
        vmovups   320(%rsp), %xmm11                             #128.5[spill]
        vmovups   464(%rsp), %xmm10                             #128.5[spill]
        vmovups   432(%rsp), %xmm9                              #128.5[spill]
        vmovups   384(%rsp), %xmm8                              #128.5[spill]
        vmovups   416(%rsp), %xmm7                              #128.5[spill]
        vmovups   352(%rsp), %xmm6                              #128.5[spill]
        vmovups   336(%rsp), %xmm5                              #128.5[spill]
        vmovups   448(%rsp), %xmm4                              #128.5[spill]
        vmovups   304(%rsp), %xmm3                              #128.5[spill]
        vmovups   400(%rsp), %xmm2                              #128.5[spill]
        vmovups   272(%rsp), %xmm1                              #128.5[spill]
        vmovups   288(%rsp), %xmm0                              #128.5[spill]
        vmovups   (%rsp), %xmm15                                #128.5[spill]
        vpaddb    16(%rsp), %xmm14, %xmm14                      #128.5[spill]
        vpaddb    32(%rsp), %xmm13, %xmm13                      #128.5[spill]
        vpaddb    48(%rsp), %xmm12, %xmm12                      #128.5[spill]
        vpaddb    80(%rsp), %xmm11, %xmm11                      #128.5[spill]
        vpaddb    112(%rsp), %xmm10, %xmm10                     #128.5[spill]
        vpaddb    128(%rsp), %xmm9, %xmm9                       #128.5[spill]
        vpaddb    144(%rsp), %xmm8, %xmm8                       #128.5[spill]
        vpaddb    176(%rsp), %xmm7, %xmm7                       #128.5[spill]
        vpaddb    192(%rsp), %xmm6, %xmm6                       #128.5[spill]
        vpaddb    208(%rsp), %xmm5, %xmm5                       #128.5[spill]
        vpaddb    224(%rsp), %xmm4, %xmm4                       #128.5[spill]
        vpaddb    240(%rsp), %xmm3, %xmm3                       #128.5[spill]
        vpaddb    256(%rsp), %xmm2, %xmm2                       #128.5[spill]
        vpaddb    64(%rsp), %xmm1, %xmm1                        #128.5[spill]
        vpaddb    96(%rsp), %xmm0, %xmm0                        #128.5[spill]
        vpaddb    160(%rsp), %xmm15, %xmm15                     #128.5[spill]
...
..B1.140:                       # Preds ..B1.140 ..B1.139
        ...
        incl      %edx                                          #127.3
        lea       (%rax,%rbx), %rsi                             #128.5
        vmovdqu   %xmm9, 80(%rsi)                               #128.5
        vmovdqu   %xmm8, 96(%rsi)                               #128.5
        vmovdqu   %xmm7, 112(%rsi)                              #128.5
        vmovdqu   %xmm6, 128(%rsi)                              #128.5
        vmovdqu   %xmm5, 144(%rsi)                              #128.5
        vmovdqu   %xmm4, 160(%rsi)                              #128.5
        vmovdqu   %xmm3, 176(%rsi)                              #128.5
        vmovdqu   %xmm2, 192(%rsi)                              #128.5
        vmovdqu   %xmm1, 208(%rsi)                              #128.5
        vmovdqu   %xmm0, 224(%rsi)                              #128.5
        vmovdqu   %xmm15, 240(%rsi)                             #128.5
        addq      $256, %rax                                    #127.3
        vmovdqu   %xmm14, (%rsi)                                #128.5
        vmovdqu   %xmm13, 16(%rsi)                              #128.5
        vmovdqu   %xmm12, 32(%rsi)                              #128.5
        vmovdqu   %xmm11, 48(%rsi)                              #128.5
        vmovdqu   %xmm10, 64(%rsi)                              #128.5
        cmpl      $1000000, %edx                                #127.3
        jb        ..B1.139      # Prob 82%                      #127.3
                                # LOE rax rbx r8 r12 edx xmm0 xmm1 xmm2 xmm3 xmm4 xmm5 xmm6 xmm7 xmm8 xmm9 xmm10 xmm11 xmm12 xmm13 xmm14 xmm15
..B1.141:                       # Preds ..B1.140
                                # Execution count [1.00e+00]
        rdtscp                                                   #131.9
...
..B1.147:                       # Preds ..B1.289
                                # Execution count [9.00e-01]
        vmovups   496(%rsp), %xmm14                             #138.5[spill]
        vmovups   480(%rsp), %xmm13                             #138.5[spill]
        vmovups   368(%rsp), %xmm12                             #138.5[spill]
        vmovups   320(%rsp), %xmm11                             #138.5[spill]
        vmovups   464(%rsp), %xmm10                             #138.5[spill]
        vmovups   432(%rsp), %xmm9                              #138.5[spill]
        vmovups   384(%rsp), %xmm8                              #138.5[spill]
        vmovups   416(%rsp), %xmm7                              #138.5[spill]
        vmovups   352(%rsp), %xmm6                              #138.5[spill]
        vmovups   336(%rsp), %xmm5                              #138.5[spill]
        vmovups   448(%rsp), %xmm4                              #138.5[spill]
        vmovups   304(%rsp), %xmm3                              #138.5[spill]
        vmovups   400(%rsp), %xmm2                              #138.5[spill]
        vmovups   272(%rsp), %xmm1                              #138.5[spill]
        vmovups   288(%rsp), %xmm0                              #138.5[spill]
        vmovups   (%rsp), %xmm15                                #138.5[spill]
        vxorps    16(%rsp), %xmm14, %xmm14                      #138.5[spill]
        vxorps    32(%rsp), %xmm13, %xmm13                      #138.5[spill]
        vxorps    48(%rsp), %xmm12, %xmm12                      #138.5[spill]
        vxorps    80(%rsp), %xmm11, %xmm11                      #138.5[spill]
        vxorps    112(%rsp), %xmm10, %xmm10                     #138.5[spill]
        vxorps    128(%rsp), %xmm9, %xmm9                       #138.5[spill]
        vxorps    144(%rsp), %xmm8, %xmm8                       #138.5[spill]
        vxorps    176(%rsp), %xmm7, %xmm7                       #138.5[spill]
        vxorps    192(%rsp), %xmm6, %xmm6                       #138.5[spill]
        vxorps    208(%rsp), %xmm5, %xmm5                       #138.5[spill]
        vxorps    224(%rsp), %xmm4, %xmm4                       #138.5[spill]
        vxorps    240(%rsp), %xmm3, %xmm3                       #138.5[spill]
        vxorps    256(%rsp), %xmm2, %xmm2                       #138.5[spill]
        vxorps    64(%rsp), %xmm1, %xmm1                        #138.5[spill]
        vxorps    96(%rsp), %xmm0, %xmm0                        #138.5[spill]
        vxorps    160(%rsp), %xmm15, %xmm15                     #138.5[spill]
                                # LOE rax rbx r8 r12 edx xmm0 xmm1 xmm2 xmm3 xmm4 xmm5 xmm6 xmm7 xmm8 xmm9 xmm10 xmm11 xmm12 xmm13 xmm14 xmm15
..B1.148:                       # Preds ..B1.148 ..B1.147
                                # Execution count [5.00e+00]
        incl      %edx                                          #137.3
        lea       (%rax,%rbx), %rsi                             #138.5
        vmovups   %xmm9, 80(%rsi)                               #138.5
        vmovups   %xmm8, 96(%rsi)                               #138.5
        vmovups   %xmm7, 112(%rsi)                              #138.5
        vmovups   %xmm6, 128(%rsi)                              #138.5
        vmovups   %xmm5, 144(%rsi)                              #138.5
        vmovups   %xmm4, 160(%rsi)                              #138.5
        vmovups   %xmm3, 176(%rsi)                              #138.5
        vmovups   %xmm2, 192(%rsi)                              #138.5
        vmovups   %xmm1, 208(%rsi)                              #138.5
        vmovups   %xmm0, 224(%rsi)                              #138.5
        vmovups   %xmm15, 240(%rsi)                             #138.5
        addq      $256, %rax                                    #137.3
        vmovups   %xmm14, (%rsi)                                #138.5
        vmovups   %xmm13, 16(%rsi)                              #138.5
        vmovups   %xmm12, 32(%rsi)                              #138.5
        vmovups   %xmm11, 48(%rsi)                              #138.5
        vmovups   %xmm10, 64(%rsi)                              #138.5
        cmpl      $1000000, %edx                                #137.3
        jb        ..B1.147      # Prob 82%                      #137.3
                                # LOE rax rbx r8 r12 edx xmm0 xmm1 xmm2 xmm3 xmm4 xmm5 xmm6 xmm7 xmm8 xmm9 xmm10 xmm11 xmm12 xmm13 xmm14 xmm15
..B1.149:                       # Preds ..B1.148
                                # Execution count [1.00e+00]
        rdtscp                                                   #141.9
