...
void add_bitslice (__m128i x1, __m128i x2, __m128i x3, __m128i x4,
  ...
  out[0] = _mm_xor_si128(x1,y1);
  out[1] = _mm_xor_si128(x2,y2);
  out[2] = _mm_xor_si128(x3,y3);
  out[3] = _mm_xor_si128(x4,y4);
  out[4] = _mm_xor_si128(x5,y5);
  out[5] = _mm_xor_si128(x6,y6);
  out[6] = _mm_xor_si128(x7,y7);
  out[7] = _mm_xor_si128(x8,y8);
  out[8] = _mm_xor_si128(x9,y9);
  out[9] = _mm_xor_si128(x10,y10);
  out[10] = _mm_xor_si128(x11,y11);
  out[11] = _mm_xor_si128(x12,y12);
  out[12] = _mm_xor_si128(x13,y13);
  out[13] = _mm_xor_si128(x14,y14);
  out[14] = _mm_xor_si128(x15,y15);
  out[15] = _mm_xor_si128(x16,y16); 
}
