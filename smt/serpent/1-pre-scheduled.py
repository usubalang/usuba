...
def orig_Serpent_(plaintext_,keys_):
  ...
  tmp_[0][0] = plaintext_[0]
  tmp_[0][1] = plaintext_[1]
  tmp_[0][2] = plaintext_[2]
  tmp_[0][3] = plaintext_[3]
  _tmp7_[0] = tmp_[0][0] ^ keys_[0][0]
  _tmp7_[1] = tmp_[0][1] ^ keys_[0][1]
  _tmp7_[2] = tmp_[0][2] ^ keys_[0][2]
  _tmp7_[3] = tmp_[0][3] ^ keys_[0][3]
