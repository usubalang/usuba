...
def dest_Serpent_(plaintext_,keys_):
  ...
  (tmp_) = dest_transform_V32(_tmp8_)
  _tmp9_[0] = tmp_[0] ^ keys_[1][0]
  _tmp9_[1] = tmp_[1] ^ keys_[1][1]
  _tmp9_[2] = tmp_[2] ^ keys_[1][2]
  _tmp9_[3] = tmp_[3] ^ keys_[1][3]
  (_tmp10_[0],_tmp10_[1],_tmp10_[2],_tmp10_[3]) = dest_sbox_1_V32(_tmp9_[0],_tmp9_[1],_tmp9_[2],_tmp9_[3])
  (tmp_) = dest_transform_V32(_tmp10_)
  _tmp11_[0] = tmp_[0] ^ keys_[2][0]
  _tmp11_[1] = tmp_[1] ^ keys_[2][1]
  _tmp11_[2] = tmp_[2] ^ keys_[2][2]
  _tmp11_[3] = tmp_[3] ^ keys_[2][3]
  (_tmp12_[0],_tmp12_[1],_tmp12_[2],_tmp12_[3]) = dest_sbox_2_V32(_tmp11_[0],_tmp11_[1],_tmp11_[2],_tmp11_[3])
  (tmp_) = dest_transform_V32(_tmp12_)
  _tmp13_[0] = tmp_[0] ^ keys_[3][0]
  _tmp13_[1] = tmp_[1] ^ keys_[3][1]
  _tmp13_[2] = tmp_[2] ^ keys_[3][2]
  _tmp13_[3] = tmp_[3] ^ keys_[3][3]
  (_tmp14_[0],_tmp14_[1],_tmp14_[2],_tmp14_[3]) = dest_sbox_3_V32(_tmp13_[0],_tmp13_[1],_tmp13_[2],_tmp13_[3])
  (tmp_) = dest_transform_V32(_tmp14_)
  _tmp15_[0] = tmp_[0] ^ keys_[4][0]
  _tmp15_[1] = tmp_[1] ^ keys_[4][1]
  _tmp15_[2] = tmp_[2] ^ keys_[4][2]
  _tmp15_[3] = tmp_[3] ^ keys_[4][3]
  (_tmp16_[0],_tmp16_[1],_tmp16_[2],_tmp16_[3]) = dest_sbox_4_V32(_tmp15_[0],_tmp15_[1],_tmp15_[2],_tmp15_[3])
  (tmp_) = dest_transform_V32(_tmp16_)
  _tmp17_[0] = tmp_[0] ^ keys_[5][0]
  _tmp17_[1] = tmp_[1] ^ keys_[5][1]
  _tmp17_[2] = tmp_[2] ^ keys_[5][2]
  _tmp17_[3] = tmp_[3] ^ keys_[5][3]
  (_tmp18_[0],_tmp18_[1],_tmp18_[2],_tmp18_[3]) = dest_sbox_5_V32(_tmp17_[0],_tmp17_[1],_tmp17_[2],_tmp17_[3])
  (tmp_) = dest_transform_V32(_tmp18_)
  _tmp19_[0] = tmp_[0] ^ keys_[6][0]
  _tmp19_[1] = tmp_[1] ^ keys_[6][1]
  _tmp19_[2] = tmp_[2] ^ keys_[6][2]
  _tmp19_[3] = tmp_[3] ^ keys_[6][3]
  (_tmp20_[0],_tmp20_[1],_tmp20_[2],_tmp20_[3]) = dest_sbox_6_V32(_tmp19_[0],_tmp19_[1],_tmp19_[2],_tmp19_[3])
  (tmp_) = dest_transform_V32(_tmp20_)
  _tmp21_[0] = tmp_[0] ^ keys_[7][0]
  _tmp21_[1] = tmp_[1] ^ keys_[7][1]
  _tmp21_[2] = tmp_[2] ^ keys_[7][2]
  _tmp21_[3] = tmp_[3] ^ keys_[7][3]
  (_tmp22_[0],_tmp22_[1],_tmp22_[2],_tmp22_[3]) = dest_sbox_7_V32(_tmp21_[0],_tmp21_[1],_tmp21_[2],_tmp21_[3])
  (tmp_) = dest_transform_V32(_tmp22_)
  _tmp23_[0] = tmp_[0] ^ keys_[8][0]
  _tmp23_[1] = tmp_[1] ^ keys_[8][1]
  _tmp23_[2] = tmp_[2] ^ keys_[8][2]
  _tmp23_[3] = tmp_[3] ^ keys_[8][3]
  (_tmp24_[0],_tmp24_[1],_tmp24_[2],_tmp24_[3]) = dest_sbox_0_V32(_tmp23_[0],_tmp23_[1],_tmp23_[2],_tmp23_[3])
  (tmp_) = dest_transform_V32(_tmp24_)
  _tmp25_[0] = tmp_[0] ^ keys_[9][0]
  _tmp25_[1] = tmp_[1] ^ keys_[9][1]
  _tmp25_[2] = tmp_[2] ^ keys_[9][2]
  _tmp25_[3] = tmp_[3] ^ keys_[9][3]
  (_tmp26_[0],_tmp26_[1],_tmp26_[2],_tmp26_[3]) = dest_sbox_1_V32(_tmp25_[0],_tmp25_[1],_tmp25_[2],_tmp25_[3])
  (tmp_) = dest_transform_V32(_tmp26_)
  _tmp27_[0] = tmp_[0] ^ keys_[10][0]
  _tmp27_[1] = tmp_[1] ^ keys_[10][1]
  _tmp27_[2] = tmp_[2] ^ keys_[10][2]
  _tmp27_[3] = tmp_[3] ^ keys_[10][3]
  (_tmp28_[0],_tmp28_[1],_tmp28_[2],_tmp28_[3]) = dest_sbox_2_V32(_tmp27_[0],_tmp27_[1],_tmp27_[2],_tmp27_[3])
  (tmp_) = dest_transform_V32(_tmp28_)
  _tmp29_[0] = tmp_[0] ^ keys_[11][0]
  _tmp29_[1] = tmp_[1] ^ keys_[11][1]
  _tmp29_[2] = tmp_[2] ^ keys_[11][2]
  _tmp29_[3] = tmp_[3] ^ keys_[11][3]
  (_tmp30_[0],_tmp30_[1],_tmp30_[2],_tmp30_[3]) = dest_sbox_3_V32(_tmp29_[0],_tmp29_[1],_tmp29_[2],_tmp29_[3])
  (tmp_) = dest_transform_V32(_tmp30_)
  _tmp31_[0] = tmp_[0] ^ keys_[12][0]
  _tmp31_[1] = tmp_[1] ^ keys_[12][1]
  _tmp31_[2] = tmp_[2] ^ keys_[12][2]
  _tmp31_[3] = tmp_[3] ^ keys_[12][3]
  (_tmp32_[0],_tmp32_[1],_tmp32_[2],_tmp32_[3]) = dest_sbox_4_V32(_tmp31_[0],_tmp31_[1],_tmp31_[2],_tmp31_[3])
  (tmp_) = dest_transform_V32(_tmp32_)
  _tmp33_[0] = tmp_[0] ^ keys_[13][0]
  _tmp33_[1] = tmp_[1] ^ keys_[13][1]
  _tmp33_[2] = tmp_[2] ^ keys_[13][2]
  _tmp33_[3] = tmp_[3] ^ keys_[13][3]
  (_tmp34_[0],_tmp34_[1],_tmp34_[2],_tmp34_[3]) = dest_sbox_5_V32(_tmp33_[0],_tmp33_[1],_tmp33_[2],_tmp33_[3])
  (tmp_) = dest_transform_V32(_tmp34_)
  _tmp35_[0] = tmp_[0] ^ keys_[14][0]
  _tmp35_[1] = tmp_[1] ^ keys_[14][1]
  _tmp35_[2] = tmp_[2] ^ keys_[14][2]
  _tmp35_[3] = tmp_[3] ^ keys_[14][3]
  (_tmp36_[0],_tmp36_[1],_tmp36_[2],_tmp36_[3]) = dest_sbox_6_V32(_tmp35_[0],_tmp35_[1],_tmp35_[2],_tmp35_[3])
  (tmp_) = dest_transform_V32(_tmp36_)
  _tmp37_[0] = tmp_[0] ^ keys_[15][0]
  _tmp37_[1] = tmp_[1] ^ keys_[15][1]
  _tmp37_[2] = tmp_[2] ^ keys_[15][2]
  _tmp37_[3] = tmp_[3] ^ keys_[15][3]
  (_tmp38_[0],_tmp38_[1],_tmp38_[2],_tmp38_[3]) = dest_sbox_7_V32(_tmp37_[0],_tmp37_[1],_tmp37_[2],_tmp37_[3])
  (tmp_) = dest_transform_V32(_tmp38_)
  _tmp39_[0] = tmp_[0] ^ keys_[16][0]
  _tmp39_[1] = tmp_[1] ^ keys_[16][1]
  _tmp39_[2] = tmp_[2] ^ keys_[16][2]
  _tmp39_[3] = tmp_[3] ^ keys_[16][3]
  (_tmp40_[0],_tmp40_[1],_tmp40_[2],_tmp40_[3]) = dest_sbox_0_V32(_tmp39_[0],_tmp39_[1],_tmp39_[2],_tmp39_[3])
  (tmp_) = dest_transform_V32(_tmp40_)
  _tmp41_[0] = tmp_[0] ^ keys_[17][0]
  _tmp41_[1] = tmp_[1] ^ keys_[17][1]
  _tmp41_[2] = tmp_[2] ^ keys_[17][2]
  _tmp41_[3] = tmp_[3] ^ keys_[17][3]
  (_tmp42_[0],_tmp42_[1],_tmp42_[2],_tmp42_[3]) = dest_sbox_1_V32(_tmp41_[0],_tmp41_[1],_tmp41_[2],_tmp41_[3])
  (tmp_) = dest_transform_V32(_tmp42_)
  _tmp43_[0] = tmp_[0] ^ keys_[18][0]
  _tmp43_[1] = tmp_[1] ^ keys_[18][1]
  _tmp43_[2] = tmp_[2] ^ keys_[18][2]
  _tmp43_[3] = tmp_[3] ^ keys_[18][3]
  (_tmp44_[0],_tmp44_[1],_tmp44_[2],_tmp44_[3]) = dest_sbox_2_V32(_tmp43_[0],_tmp43_[1],_tmp43_[2],_tmp43_[3])
  (tmp_) = dest_transform_V32(_tmp44_)
  _tmp45_[0] = tmp_[0] ^ keys_[19][0]
  _tmp45_[1] = tmp_[1] ^ keys_[19][1]
  _tmp45_[2] = tmp_[2] ^ keys_[19][2]
  _tmp45_[3] = tmp_[3] ^ keys_[19][3]
  (_tmp46_[0],_tmp46_[1],_tmp46_[2],_tmp46_[3]) = dest_sbox_3_V32(_tmp45_[0],_tmp45_[1],_tmp45_[2],_tmp45_[3])
  (tmp_) = dest_transform_V32(_tmp46_)
  _tmp47_[0] = tmp_[0] ^ keys_[20][0]
  _tmp47_[1] = tmp_[1] ^ keys_[20][1]
  _tmp47_[2] = tmp_[2] ^ keys_[20][2]
  _tmp47_[3] = tmp_[3] ^ keys_[20][3]
  (_tmp48_[0],_tmp48_[1],_tmp48_[2],_tmp48_[3]) = dest_sbox_4_V32(_tmp47_[0],_tmp47_[1],_tmp47_[2],_tmp47_[3])
  (tmp_) = dest_transform_V32(_tmp48_)
  _tmp49_[0] = tmp_[0] ^ keys_[21][0]
  _tmp49_[1] = tmp_[1] ^ keys_[21][1]
  _tmp49_[2] = tmp_[2] ^ keys_[21][2]
  _tmp49_[3] = tmp_[3] ^ keys_[21][3]
  (_tmp50_[0],_tmp50_[1],_tmp50_[2],_tmp50_[3]) = dest_sbox_5_V32(_tmp49_[0],_tmp49_[1],_tmp49_[2],_tmp49_[3])
  (tmp_) = dest_transform_V32(_tmp50_)
  _tmp51_[0] = tmp_[0] ^ keys_[22][0]
  _tmp51_[1] = tmp_[1] ^ keys_[22][1]
  _tmp51_[2] = tmp_[2] ^ keys_[22][2]
  _tmp51_[3] = tmp_[3] ^ keys_[22][3]
  (_tmp52_[0],_tmp52_[1],_tmp52_[2],_tmp52_[3]) = dest_sbox_6_V32(_tmp51_[0],_tmp51_[1],_tmp51_[2],_tmp51_[3])
  (tmp_) = dest_transform_V32(_tmp52_)
  _tmp53_[0] = tmp_[0] ^ keys_[23][0]
  _tmp53_[1] = tmp_[1] ^ keys_[23][1]
  _tmp53_[2] = tmp_[2] ^ keys_[23][2]
  _tmp53_[3] = tmp_[3] ^ keys_[23][3]
  (_tmp54_[0],_tmp54_[1],_tmp54_[2],_tmp54_[3]) = dest_sbox_7_V32(_tmp53_[0],_tmp53_[1],_tmp53_[2],_tmp53_[3])
  (tmp_) = dest_transform_V32(_tmp54_)
  _tmp55_[0] = tmp_[0] ^ keys_[24][0]
  _tmp55_[1] = tmp_[1] ^ keys_[24][1]
  _tmp55_[2] = tmp_[2] ^ keys_[24][2]
  _tmp55_[3] = tmp_[3] ^ keys_[24][3]
  (_tmp56_[0],_tmp56_[1],_tmp56_[2],_tmp56_[3]) = dest_sbox_0_V32(_tmp55_[0],_tmp55_[1],_tmp55_[2],_tmp55_[3])
  (tmp_) = dest_transform_V32(_tmp56_)
  _tmp57_[0] = tmp_[0] ^ keys_[25][0]
  _tmp57_[1] = tmp_[1] ^ keys_[25][1]
  _tmp57_[2] = tmp_[2] ^ keys_[25][2]
  _tmp57_[3] = tmp_[3] ^ keys_[25][3]
  (_tmp58_[0],_tmp58_[1],_tmp58_[2],_tmp58_[3]) = dest_sbox_1_V32(_tmp57_[0],_tmp57_[1],_tmp57_[2],_tmp57_[3])
  (tmp_) = dest_transform_V32(_tmp58_)
  _tmp59_[0] = tmp_[0] ^ keys_[26][0]
  _tmp59_[1] = tmp_[1] ^ keys_[26][1]
  _tmp59_[2] = tmp_[2] ^ keys_[26][2]
  _tmp59_[3] = tmp_[3] ^ keys_[26][3]
  (_tmp60_[0],_tmp60_[1],_tmp60_[2],_tmp60_[3]) = dest_sbox_2_V32(_tmp59_[0],_tmp59_[1],_tmp59_[2],_tmp59_[3])
  (tmp_) = dest_transform_V32(_tmp60_)
  _tmp61_[0] = tmp_[0] ^ keys_[27][0]
  _tmp61_[1] = tmp_[1] ^ keys_[27][1]
  _tmp61_[2] = tmp_[2] ^ keys_[27][2]
  _tmp61_[3] = tmp_[3] ^ keys_[27][3]
  (_tmp62_[0],_tmp62_[1],_tmp62_[2],_tmp62_[3]) = dest_sbox_3_V32(_tmp61_[0],_tmp61_[1],_tmp61_[2],_tmp61_[3])
  (tmp_) = dest_transform_V32(_tmp62_)
  _tmp63_[0] = tmp_[0] ^ keys_[28][0]
  _tmp63_[1] = tmp_[1] ^ keys_[28][1]
  _tmp63_[2] = tmp_[2] ^ keys_[28][2]
  _tmp63_[3] = tmp_[3] ^ keys_[28][3]
  (_tmp64_[0],_tmp64_[1],_tmp64_[2],_tmp64_[3]) = dest_sbox_4_V32(_tmp63_[0],_tmp63_[1],_tmp63_[2],_tmp63_[3])
  (tmp_) = dest_transform_V32(_tmp64_)
  _tmp65_[0] = tmp_[0] ^ keys_[29][0]
  _tmp65_[1] = tmp_[1] ^ keys_[29][1]
  _tmp65_[2] = tmp_[2] ^ keys_[29][2]
  _tmp65_[3] = tmp_[3] ^ keys_[29][3]
  (_tmp66_[0],_tmp66_[1],_tmp66_[2],_tmp66_[3]) = dest_sbox_5_V32(_tmp65_[0],_tmp65_[1],_tmp65_[2],_tmp65_[3])
  (tmp_) = dest_transform_V32(_tmp66_)
  _tmp67_[0] = tmp_[0] ^ keys_[30][0]
  _tmp67_[1] = tmp_[1] ^ keys_[30][1]
  _tmp67_[2] = tmp_[2] ^ keys_[30][2]
  _tmp67_[3] = tmp_[3] ^ keys_[30][3]
  (_tmp68_[0],_tmp68_[1],_tmp68_[2],_tmp68_[3]) = dest_sbox_6_V32(_tmp67_[0],_tmp67_[1],_tmp67_[2],_tmp67_[3])
  (tmp_) = dest_transform_V32(_tmp68_)
  _tmp69_[0] = tmp_[0] ^ keys_[31][0]
  _tmp69_[1] = tmp_[1] ^ keys_[31][1]
  _tmp69_[2] = tmp_[2] ^ keys_[31][2]
  _tmp69_[3] = tmp_[3] ^ keys_[31][3]
