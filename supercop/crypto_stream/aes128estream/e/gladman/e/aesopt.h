...
#ifdef crypto_stream_aes128estream_e_gladman_ECRYPT_API

#if defined(crypto_stream_aes128estream_e_gladman_ECRYPT_LITTLE_ENDIAN)
#define PLATFORM_BYTE_ORDER BRG_LITTLE_ENDIAN
#elif defined(crypto_stream_aes128estream_e_gladman_ECRYPT_BIG_ENDIAN)
...
#if defined( AES_Dcrypto_stream_aes128estream_e_gladman_ECRYPT )
#define Dcrypto_stream_aes128estream_e_gladman_ECRYPTION
#define Dcrypto_stream_aes128estream_e_gladman_ECRYPTION_KEY_SCHEDULE
#endif
...
#if defined(ENCRYPTION_KEY_SCHEDULE) || defined(Dcrypto_stream_aes128estream_e_gladman_ECRYPTION_KEY_SCHEDULE)
