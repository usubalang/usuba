/* This code was generated by Usuba.
   ...
   From the file "nist/pyjamask/usuba/ua_masked/pyjamask_vslice.ua" (included below). */
...
void mat_mult__V32 (/*inputs*/ DATATYPE col__,DATATYPE vec__[MASKING_ORDER], /*outputs*/ DATATYPE res__[MASKING_ORDER]) {
...
#define AND_NOMASK(r,a,b) for (int i_ = 0; i_ < MASKING_ORDER; i_++) r[i_] = a[i_] & b;
    AND_NOMASK(_tmp6_,mask__,mat_col__);
    XOR(res_tmp__,res_tmp__,_tmp6_);
    mat_col__ = (mat_col__ >> 1) | (mat_col__ << 31);// R_ROTATE(mat_col__,mat_col__,1,32);
  }
