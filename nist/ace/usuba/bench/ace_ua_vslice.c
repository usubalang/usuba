...
void simeck_box__V32 (/*inputs*/ DATATYPE input__[2],DATATYPE rc__, /*outputs*/ DATATYPE output__[2]) {
  ...
  for (int i__ = 0; i__ <= 7; i__++) {
    ...
    _tmp6_ = XOR(_tmp5_,round__[i__][1]);
    _tmp7_ = LIFT_32(4294967294);
    _tmp8_ = XOR(_tmp6_,_tmp7_);
    _tmp9_ = R_SHIFT(rc__,i__,32);
    _tmp10_ = LIFT_32(1);
    _tmp11_ = AND(_tmp9_,_tmp10_);
...
void ACE_step__V32 (/*inputs*/ DATATYPE A__[2],DATATYPE B__[2],DATATYPE C__[2],DATATYPE D__[2],DATATYPE E__[2],DATATYPE RC__0__,DATATYPE RC__1__,DATATYPE RC__2__,DATATYPE SC__0__,DATATYPE SC__1__,DATATYPE SC__2__, /*outputs*/ DATATYPE Ar__[2],DATATYPE Br__[2],DATATYPE Cr__[2],DATATYPE Dr__[2],DATATYPE Er__[2]) {
  ...
  _tmp12_[0] = XOR(B__[0],_shadow_C__2_[0]);
  _tmp12_[1] = XOR(B__[1],_shadow_C__2_[1]);
  _tmp14_ = XOR(_tmp12_[1],SC__0__);
  _shadow_B__4_[0] = NOT(_tmp12_[0]);
  _tmp123_ = LIFT_32(4294967040);
  _shadow_B__4_[1] = XOR(_tmp14_,_tmp123_);
  _tmp17_[0] = XOR(D__[0],_shadow_E__3_[0]);
  _tmp17_[1] = XOR(D__[1],_shadow_E__3_[1]);
  _tmp19_ = XOR(_tmp17_[1],SC__1__);
  _shadow_D__5_[0] = NOT(_tmp17_[0]);
  _tmp124_ = LIFT_32(4294967040);
  _shadow_D__5_[1] = XOR(_tmp19_,_tmp124_);
  _tmp22_[0] = XOR(_shadow_E__3_[0],_shadow_A__1_[0]);
  _tmp22_[1] = XOR(_shadow_E__3_[1],_shadow_A__1_[1]);
  _tmp24_ = XOR(_tmp22_[1],SC__2__);
  _shadow_E__6_[0] = NOT(_tmp22_[0]);
  _tmp125_ = LIFT_32(4294967040);
  _shadow_E__6_[1] = XOR(_tmp24_,_tmp125_);
