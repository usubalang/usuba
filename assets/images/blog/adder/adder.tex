...
\begin{tikzpicture}[%
  ...
  \node[and gate,minimum size=0.6cm] at ($(2,-1)$) (and2) {};
  ...
  \draw (a.east) --++(180:-4mm) |- (and2.input 2);
  \draw (b.east) --++(180:-7mm) |- (and2.input 1);

  \draw (xor1.output) --++(180:-4mm) |- (and1.input 1);
  \draw (cin.east) --++(180:-5mm)    |- (and1.input 2);

  \draw (and1.output) --++(180:-6mm) |- (xor3.input 1);
  \draw (and2.output) --++(180:-26mm) |- (xor3.input 2);
