...
/* main function */
void Rectangle__ (/*inputs*/ DATATYPE plain__[4],DATATYPE plain____2[4],DATATYPE key__[26][4],DATATYPE key____2[26][4], /*outputs*/ DATATYPE cipher__[4],DATATYPE cipher____2[4]) {
  ...
  for (int i = 0; i <= 24; i++) {
    ...
    _tmp1___2[0] = XOR(tmp____2[0],key____2[i][0]);
    _tmp1___2[1] = XOR(tmp____2[1],key____2[i][1]);
    _tmp1___2[2] = XOR(tmp____2[2],key____2[i][2]);
    _tmp1___2[3] = XOR(tmp____2[3],key____2[i][3]);
  ...
  cipher____2[0] = XOR(tmp____2[0],key____2[25][0]);
  cipher____2[1] = XOR(tmp____2[1],key____2[25][1]);
  cipher____2[2] = XOR(tmp____2[2],key____2[25][2]);
  cipher____2[3] = XOR(tmp____2[3],key____2[25][3]);
