...
#define TRANSPOSE4_IN(x0, x1, x2, x3) {                     \
    ...
    __m512i ymm45 = x2;                                     \
    __m512i ymm67 = x3;                                     \
	__m512i ymm02 = _mm512_unpacklo_epi64(ymm01, ymm23);    \
	__m512i ymm13 = _mm512_unpackhi_epi64(ymm01, ymm23);    \
	ymm01 = _mm512_unpacklo_epi16(ymm02, ymm13);            \
	ymm23 = _mm512_unpackhi_epi16(ymm02, ymm13);            \
	ymm02 = _mm512_unpacklo_epi32(ymm01, ymm23);            \
	ymm13 = _mm512_unpackhi_epi32(ymm01, ymm23);            \
	__m512i ymm46 = _mm512_unpacklo_epi64(ymm45, ymm67);    \
	__m512i ymm57 = _mm512_unpackhi_epi64(ymm45, ymm67);    \
	ymm45 = _mm512_unpacklo_epi16(ymm46, ymm57);            \
	ymm67 = _mm512_unpackhi_epi16(ymm46, ymm57);            \
	ymm46 = _mm512_unpacklo_epi32(ymm45, ymm67);            \
	ymm57 = _mm512_unpackhi_epi32(ymm45, ymm67);            \
	x0    = _mm512_unpacklo_epi64(ymm02, ymm46);            \
	x1    = _mm512_unpackhi_epi64(ymm02, ymm46);            \
	x2    = _mm512_unpacklo_epi64(ymm13, ymm57);            \
	x3    = _mm512_unpackhi_epi64(ymm13, ymm57);            \
  }

#define TRANSPOSE4_OUT(x0, x1, x2, x3) {            \
	__m512i ymm01 = _mm512_unpacklo_epi16(x0, x1);  \
	__m512i ymm45 = _mm512_unpackhi_epi16(x0, x1);  \
	__m512i ymm23 = _mm512_unpacklo_epi16(x2, x3);  \
	__m512i ymm67 = _mm512_unpackhi_epi16(x2, x3);  \
	x0    = _mm512_unpacklo_epi32(ymm01, ymm23);    \
	x1    = _mm512_unpackhi_epi32(ymm01, ymm23);    \
	x2    = _mm512_unpacklo_epi32(ymm45, ymm67);    \
	x3    = _mm512_unpackhi_epi32(ymm45, ymm67);    \
  }
