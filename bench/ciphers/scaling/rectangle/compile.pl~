...
if ($gen) {
    ...
    for my $arch (@archs) {
        ...
        system "./usubac -arch $arch -o bench/ciphers/rectangle/hslice/$arch.c samples/usuba/rectangle_nslice.ua" if $arch ne 'std';
        system "./usubac -no-share -no-arr -arch $arch -o bench/ciphers/rectangle/bitslice/$arch.c samples/usuba/rectangle_bitslice.ua";
        system "./usubac $add_opt -lf -arch $arch -o bench/ciphers/rectangle/vslice/$arch.c samples/usuba/rectangle_vector.ua";
        system "./usubac $add_opt -lf -arch $arch -interleave 10 -o bench/ciphers/rectangle/vslice-inter/$arch.c samples/usuba/rectangle_vector.ua";
    }
    chdir "$FindBin::Bin";
    say " done.";
}
