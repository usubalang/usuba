...
/* auxiliary functions */
void chi__V32 (/*inputs*/ DATATYPE A__[3][4],DATATYPE A____2[3][4], /*outputs*/ DATATYPE R__[3][4],DATATYPE R____2[3][4]) {

  // Variables declaration
  DATATYPE B__[3][4];
  DATATYPE B____2[3][4];
  DATATYPE _tmp4_[4];
  DATATYPE _tmp4___2[4];
  DATATYPE _tmp5_[4];
  DATATYPE _tmp5___2[4];
  DATATYPE _tmp6_[4];
  DATATYPE _tmp6___2[4];
  ...
  _tmp4___2[0] = NOT(A____2[1][0]);
  _tmp4___2[1] = NOT(A____2[1][1]);
  _tmp4___2[2] = NOT(A____2[1][2]);
  _tmp4___2[3] = NOT(A____2[1][3]);
  B__[0][0] = AND(_tmp4_[0],A__[2][0]);
  B__[0][1] = AND(_tmp4_[1],A__[2][1]);
  B__[0][2] = AND(_tmp4_[2],A__[2][2]);
  B__[0][3] = AND(_tmp4_[3],A__[2][3]);
  _tmp5___2[0] = NOT(A____2[2][0]);
  _tmp5___2[1] = NOT(A____2[2][1]);
  B____2[0][0] = AND(_tmp4___2[0],A____2[2][0]);
  B____2[0][1] = AND(_tmp4___2[1],A____2[2][1]);
  B____2[0][2] = AND(_tmp4___2[2],A____2[2][2]);
  B____2[0][3] = AND(_tmp4___2[3],A____2[2][3]);
  ...
  _tmp5___2[2] = NOT(A____2[2][2]);
  _tmp5___2[3] = NOT(A____2[2][3]);
  B__[1][2] = AND(_tmp5_[2],A__[0][2]);
  B__[1][3] = AND(_tmp5_[3],A__[0][3]);
  B____2[1][0] = AND(_tmp5___2[0],A____2[0][0]);
  B____2[1][1] = AND(_tmp5___2[1],A____2[0][1]);
  _tmp6___2[0] = NOT(A____2[0][0]);
  _tmp6___2[1] = NOT(A____2[0][1]);
  _tmp6___2[2] = NOT(A____2[0][2]);
  _tmp6___2[3] = NOT(A____2[0][3]);
  B____2[1][2] = AND(_tmp5___2[2],A____2[0][2]);
  B____2[1][3] = AND(_tmp5___2[3],A____2[0][3]);
  ...
  B____2[2][0] = AND(_tmp6___2[0],A____2[1][0]);
  B____2[2][1] = AND(_tmp6___2[1],A____2[1][1]);
  B____2[2][2] = AND(_tmp6___2[2],A____2[1][2]);
  B____2[2][3] = AND(_tmp6___2[3],A____2[1][3]);
  R____2[0][0] = XOR(A____2[0][0],B____2[0][0]);
  R____2[0][1] = XOR(A____2[0][1],B____2[0][1]);
  R____2[0][2] = XOR(A____2[0][2],B____2[0][2]);
  R____2[0][3] = XOR(A____2[0][3],B____2[0][3]);
  R____2[1][0] = XOR(A____2[1][0],B____2[1][0]);
  R____2[1][1] = XOR(A____2[1][1],B____2[1][1]);
  ...
  R____2[1][2] = XOR(A____2[1][2],B____2[1][2]);
  R____2[1][3] = XOR(A____2[1][3],B____2[1][3]);
  R____2[2][0] = XOR(A____2[2][0],B____2[2][0]);
  R____2[2][1] = XOR(A____2[2][1],B____2[2][1]);
  R____2[2][2] = XOR(A____2[2][2],B____2[2][2]);
  R____2[2][3] = XOR(A____2[2][3],B____2[2][3]);
...
void xoodoo__ (/*inputs*/ DATATYPE input__[3][4],DATATYPE input____2[3][4], /*outputs*/ DATATYPE output__[3][4],DATATYPE output____2[3][4]) {
  ...
  for (int i__ = 0; i__ <= 11; i__++) {
    ...
    for (int i__15 = 0; i__15 <= 3; i__15++) {
      ...
      round__V32_1_theta__V32_1__tmp2___2 = L_ROTATE(round__V32_1_theta__V32_1_P____2[((i__15 + 3) % 4)],5,32);
      round__V32_1_theta__V32_1__tmp3___2 = L_ROTATE(round__V32_1_theta__V32_1_P____2[((i__15 + 3) % 4)],14,32);
      round__V32_1_theta__V32_1_E__[i__15] = XOR(round__V32_1_theta__V32_1__tmp2_,round__V32_1_theta__V32_1__tmp3_);
      round__V32_1_theta__V32_1_E____2[i__15] = XOR(round__V32_1_theta__V32_1__tmp2___2,round__V32_1_theta__V32_1__tmp3___2);
    }
    for (int i__26 = 0; i__26 <= 2; i__26++) {
      ...
      round__V32_1__tmp7___2[i__26][0] = XOR(state____2[i__26][0],round__V32_1_theta__V32_1_E____2[0]);
      round__V32_1__tmp7___2[i__26][1] = XOR(state____2[i__26][1],round__V32_1_theta__V32_1_E____2[1]);
      round__V32_1__tmp7___2[i__26][2] = XOR(state____2[i__26][2],round__V32_1_theta__V32_1_E____2[2]);
      round__V32_1__tmp7___2[i__26][3] = XOR(state____2[i__26][3],round__V32_1_theta__V32_1_E____2[3]);
    }
    for (int i__37 = 0; i__37 <= 3; i__37++) {
      round__V32_1__tmp8_[2][i__37] = L_ROTATE(round__V32_1__tmp7_[2][i__37],11,32);
      round__V32_1__tmp8___2[2][i__37] = L_ROTATE(round__V32_1__tmp7___2[2][i__37],11,32);
    }
    ...
    chi__V32(round__V32_1__tmp9_,round__V32_1__tmp9___2,round__V32_1__tmp10_,round__V32_1__tmp10___2);
    for (int i__48 = 0; i__48 <= 3; i__48++) {
      ...
      state____2[1][i__48] = L_ROTATE(round__V32_1__tmp10___2[1][i__48],1,32);
      state____2[2][i__48] = L_ROTATE(round__V32_1__tmp10___2[2][((i__48 + 2) % 4)],8,32);
    }
