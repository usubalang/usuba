...
void xoodoo__ (/*inputs*/ DATATYPE input__[3][4],DATATYPE input____2[3][4], /*outputs*/ DATATYPE output__[3][4],DATATYPE output____2[3][4]) {
  ...
  DATATYPE round__V32_1__tmp10___2[3][4];
  DATATYPE round__V32_1__tmp7_[3][4];
  DATATYPE round__V32_1__tmp7___2[3][4];
  DATATYPE round__V32_1__tmp8_[3][4];
  DATATYPE round__V32_1__tmp8___2[3][4];
  DATATYPE round__V32_1__tmp9_[3][4];
  DATATYPE round__V32_1__tmp9___2[3][4];
  DATATYPE round__V32_1_chi__V32_1_B__[3][4];
  DATATYPE round__V32_1_chi__V32_1_B____2[3][4];
  DATATYPE round__V32_1_chi__V32_1__tmp4_[4];
  DATATYPE round__V32_1_chi__V32_1__tmp4___2[4];
  DATATYPE round__V32_1_chi__V32_1__tmp5_[4];
  DATATYPE round__V32_1_chi__V32_1__tmp5___2[4];
  DATATYPE round__V32_1_chi__V32_1__tmp6_[4];
  DATATYPE round__V32_1_chi__V32_1__tmp6___2[4];
  DATATYPE round__V32_1_theta__V32_1_E__[4];
  DATATYPE round__V32_1_theta__V32_1_E____2[4];
  DATATYPE round__V32_1_theta__V32_1_P__[4];
  DATATYPE round__V32_1_theta__V32_1_P____2[4];
  DATATYPE round__V32_1_theta__V32_1__tmp1_[4];
  DATATYPE round__V32_1_theta__V32_1__tmp1___2[4];
  DATATYPE round__V32_1_theta__V32_1__tmp2_;
  DATATYPE round__V32_1_theta__V32_1__tmp2___2;
  DATATYPE round__V32_1_theta__V32_1__tmp3_;
  DATATYPE round__V32_1_theta__V32_1__tmp3___2;
  ...
  RC__[9] = LIFT_32(0xf0);
  RC____2[0] = LIFT_32(0x58);
  RC____2[1] = LIFT_32(0x38);
  RC____2[2] = LIFT_32(0x3c0);
  RC____2[3] = LIFT_32(0xd0);
  RC____2[4] = LIFT_32(0x120);
  RC____2[5] = LIFT_32(0x14);
  RC____2[6] = LIFT_32(0x60);
  RC____2[7] = LIFT_32(0x2c);
  RC____2[8] = LIFT_32(0x380);
  RC____2[9] = LIFT_32(0xf0);
  ...
  RC____2[10] = LIFT_32(0x1a0);
  RC____2[11] = LIFT_32(0x12);
  state____2[0][0] = input____2[0][0];
  state____2[0][1] = input____2[0][1];
  state____2[0][2] = input____2[0][2];
  state____2[0][3] = input____2[0][3];
  state____2[1][0] = input____2[1][0];
  state____2[1][1] = input____2[1][1];
  state____2[1][2] = input____2[1][2];
  state____2[1][3] = input____2[1][3];
  ...
  state____2[2][2] = input____2[2][2];
  state____2[2][3] = input____2[2][3];
  for (int i__ = 0; i__ <= 11; i__++) {
    ...
    round__V32_1_theta__V32_1__tmp1___2[0] = XOR(state____2[0][0],state____2[1][0]);
    round__V32_1_theta__V32_1__tmp1___2[1] = XOR(state____2[0][1],state____2[1][1]);
    round__V32_1_theta__V32_1__tmp1___2[2] = XOR(state____2[0][2],state____2[1][2]);
    round__V32_1_theta__V32_1__tmp1___2[3] = XOR(state____2[0][3],state____2[1][3]);
    ...
    round__V32_1_theta__V32_1_P____2[0] = XOR(round__V32_1_theta__V32_1__tmp1___2[0],state____2[2][0]);
    round__V32_1_theta__V32_1_P____2[1] = XOR(round__V32_1_theta__V32_1__tmp1___2[1],state____2[2][1]);
    round__V32_1_theta__V32_1_P____2[2] = XOR(round__V32_1_theta__V32_1__tmp1___2[2],state____2[2][2]);
    round__V32_1_theta__V32_1_P____2[3] = XOR(round__V32_1_theta__V32_1__tmp1___2[3],state____2[2][3]);
    for (int i__16 = 0; i__16 <= 3; i__16++) {
      ...
      round__V32_1_theta__V32_1__tmp2___2 = L_ROTATE(round__V32_1_theta__V32_1_P____2[((i__16 + 3) % 4)],5,32);
      round__V32_1_theta__V32_1__tmp3___2 = L_ROTATE(round__V32_1_theta__V32_1_P____2[((i__16 + 3) % 4)],14,32);
      round__V32_1_theta__V32_1_E__[i__16] = XOR(round__V32_1_theta__V32_1__tmp2_,round__V32_1_theta__V32_1__tmp3_);
      round__V32_1_theta__V32_1_E____2[i__16] = XOR(round__V32_1_theta__V32_1__tmp2___2,round__V32_1_theta__V32_1__tmp3___2);
    }
    for (int i__27 = 0; i__27 <= 2; i__27++) {
      ...
      round__V32_1__tmp7___2[i__27][0] = XOR(state____2[i__27][0],round__V32_1_theta__V32_1_E____2[0]);
      round__V32_1__tmp7___2[i__27][1] = XOR(state____2[i__27][1],round__V32_1_theta__V32_1_E____2[1]);
      round__V32_1__tmp7___2[i__27][2] = XOR(state____2[i__27][2],round__V32_1_theta__V32_1_E____2[2]);
      round__V32_1__tmp7___2[i__27][3] = XOR(state____2[i__27][3],round__V32_1_theta__V32_1_E____2[3]);
    }
    ...
    round__V32_1__tmp8___2[0][0] = round__V32_1__tmp7___2[0][0];
    round__V32_1__tmp8___2[0][1] = round__V32_1__tmp7___2[0][1];
    round__V32_1__tmp8___2[0][2] = round__V32_1__tmp7___2[0][2];
    round__V32_1__tmp8___2[0][3] = round__V32_1__tmp7___2[0][3];
    round__V32_1__tmp8___2[1][0] = round__V32_1__tmp7___2[1][3];
    round__V32_1__tmp8___2[1][1] = round__V32_1__tmp7___2[1][0];
    round__V32_1__tmp8___2[1][2] = round__V32_1__tmp7___2[1][1];
    round__V32_1__tmp8___2[1][3] = round__V32_1__tmp7___2[1][2];
    for (int i__38 = 0; i__38 <= 3; i__38++) {
      round__V32_1__tmp8_[2][i__38] = L_ROTATE(round__V32_1__tmp7_[2][i__38],11,32);
      round__V32_1__tmp8___2[2][i__38] = L_ROTATE(round__V32_1__tmp7___2[2][i__38],11,32);
    }
    ...
    round__V32_1__tmp9___2[0][0] = XOR(round__V32_1__tmp8___2[0][0],RC____2[i__]);
    round__V32_1__tmp9___2[0][1] = round__V32_1__tmp8___2[0][1];
    round__V32_1__tmp9___2[0][2] = round__V32_1__tmp8___2[0][2];
    round__V32_1__tmp9___2[0][3] = round__V32_1__tmp8___2[0][3];
    round__V32_1__tmp9___2[1][0] = round__V32_1__tmp8___2[1][0];
    round__V32_1__tmp9___2[1][1] = round__V32_1__tmp8___2[1][1];
    round__V32_1__tmp9___2[1][2] = round__V32_1__tmp8___2[1][2];
    round__V32_1__tmp9___2[1][3] = round__V32_1__tmp8___2[1][3];
    round__V32_1__tmp9___2[2][0] = round__V32_1__tmp8___2[2][0];
    round__V32_1__tmp9___2[2][1] = round__V32_1__tmp8___2[2][1];
    ...
    round__V32_1__tmp9___2[2][2] = round__V32_1__tmp8___2[2][2];
    round__V32_1__tmp9___2[2][3] = round__V32_1__tmp8___2[2][3];
    round__V32_1_chi__V32_1__tmp4___2[0] = NOT(round__V32_1__tmp9___2[1][0]);
    round__V32_1_chi__V32_1__tmp4___2[1] = NOT(round__V32_1__tmp9___2[1][1]);
    round__V32_1_chi__V32_1__tmp4___2[2] = NOT(round__V32_1__tmp9___2[1][2]);
    round__V32_1_chi__V32_1__tmp4___2[3] = NOT(round__V32_1__tmp9___2[1][3]);
    ...
    round__V32_1_chi__V32_1_B____2[0][0] = AND(round__V32_1_chi__V32_1__tmp4___2[0],round__V32_1__tmp9___2[2][0]);
    round__V32_1_chi__V32_1_B____2[0][1] = AND(round__V32_1_chi__V32_1__tmp4___2[1],round__V32_1__tmp9___2[2][1]);
    round__V32_1_chi__V32_1_B____2[0][2] = AND(round__V32_1_chi__V32_1__tmp4___2[2],round__V32_1__tmp9___2[2][2]);
    round__V32_1_chi__V32_1_B____2[0][3] = AND(round__V32_1_chi__V32_1__tmp4___2[3],round__V32_1__tmp9___2[2][3]);
    ...
    round__V32_1_chi__V32_1__tmp5___2[0] = NOT(round__V32_1__tmp9___2[2][0]);
    round__V32_1_chi__V32_1__tmp5___2[1] = NOT(round__V32_1__tmp9___2[2][1]);
    round__V32_1_chi__V32_1__tmp5___2[2] = NOT(round__V32_1__tmp9___2[2][2]);
    round__V32_1_chi__V32_1__tmp5___2[3] = NOT(round__V32_1__tmp9___2[2][3]);
    ...
    round__V32_1_chi__V32_1__tmp6___2[0] = NOT(round__V32_1__tmp9___2[0][0]);
    round__V32_1_chi__V32_1__tmp6___2[1] = NOT(round__V32_1__tmp9___2[0][1]);
    round__V32_1_chi__V32_1__tmp6_[2] = NOT(round__V32_1__tmp9_[0][2]);
    round__V32_1_chi__V32_1__tmp6_[3] = NOT(round__V32_1__tmp9_[0][3]);
    round__V32_1_chi__V32_1_B____2[1][0] = AND(round__V32_1_chi__V32_1__tmp5___2[0],round__V32_1__tmp9___2[0][0]);
    round__V32_1_chi__V32_1_B____2[1][1] = AND(round__V32_1_chi__V32_1__tmp5___2[1],round__V32_1__tmp9___2[0][1]);
    round__V32_1_chi__V32_1_B____2[1][2] = AND(round__V32_1_chi__V32_1__tmp5___2[2],round__V32_1__tmp9___2[0][2]);
    round__V32_1_chi__V32_1_B____2[1][3] = AND(round__V32_1_chi__V32_1__tmp5___2[3],round__V32_1__tmp9___2[0][3]);
    ...
    round__V32_1_chi__V32_1__tmp6___2[2] = NOT(round__V32_1__tmp9___2[0][2]);
    round__V32_1_chi__V32_1__tmp6___2[3] = NOT(round__V32_1__tmp9___2[0][3]);
    round__V32_1_chi__V32_1_B____2[2][0] = AND(round__V32_1_chi__V32_1__tmp6___2[0],round__V32_1__tmp9___2[1][0]);
    round__V32_1_chi__V32_1_B____2[2][1] = AND(round__V32_1_chi__V32_1__tmp6___2[1],round__V32_1__tmp9___2[1][1]);
    round__V32_1__tmp10___2[0][0] = XOR(round__V32_1__tmp9___2[0][0],round__V32_1_chi__V32_1_B____2[0][0]);
    round__V32_1__tmp10___2[0][1] = XOR(round__V32_1__tmp9___2[0][1],round__V32_1_chi__V32_1_B____2[0][1]);
    round__V32_1__tmp10___2[0][2] = XOR(round__V32_1__tmp9___2[0][2],round__V32_1_chi__V32_1_B____2[0][2]);
    round__V32_1__tmp10___2[0][3] = XOR(round__V32_1__tmp9___2[0][3],round__V32_1_chi__V32_1_B____2[0][3]);
    ...
    round__V32_1_chi__V32_1_B____2[2][2] = AND(round__V32_1_chi__V32_1__tmp6___2[2],round__V32_1__tmp9___2[1][2]);
    round__V32_1_chi__V32_1_B____2[2][3] = AND(round__V32_1_chi__V32_1__tmp6___2[3],round__V32_1__tmp9___2[1][3]);
    ...
    round__V32_1__tmp10___2[1][0] = XOR(round__V32_1__tmp9___2[1][0],round__V32_1_chi__V32_1_B____2[1][0]);
    round__V32_1__tmp10___2[1][1] = XOR(round__V32_1__tmp9___2[1][1],round__V32_1_chi__V32_1_B____2[1][1]);
    round__V32_1__tmp10___2[1][2] = XOR(round__V32_1__tmp9___2[1][2],round__V32_1_chi__V32_1_B____2[1][2]);
    round__V32_1__tmp10___2[1][3] = XOR(round__V32_1__tmp9___2[1][3],round__V32_1_chi__V32_1_B____2[1][3]);
    round__V32_1__tmp10___2[2][0] = XOR(round__V32_1__tmp9___2[2][0],round__V32_1_chi__V32_1_B____2[2][0]);
    round__V32_1__tmp10___2[2][1] = XOR(round__V32_1__tmp9___2[2][1],round__V32_1_chi__V32_1_B____2[2][1]);
    round__V32_1__tmp10___2[2][2] = XOR(round__V32_1__tmp9___2[2][2],round__V32_1_chi__V32_1_B____2[2][2]);
    round__V32_1__tmp10___2[2][3] = XOR(round__V32_1__tmp9___2[2][3],round__V32_1_chi__V32_1_B____2[2][3]);
    state____2[0][0] = round__V32_1__tmp10___2[0][0];
    state____2[0][1] = round__V32_1__tmp10___2[0][1];
    state__[0][2] = round__V32_1__tmp10_[0][2];
    state__[0][3] = round__V32_1__tmp10_[0][3];
    state____2[0][2] = round__V32_1__tmp10___2[0][2];
    state____2[0][3] = round__V32_1__tmp10___2[0][3];
    for (int i__49 = 0; i__49 <= 3; i__49++) {
      state__[1][i__49] = L_ROTATE(round__V32_1__tmp10_[1][i__49],1,32);
      state____2[1][i__49] = L_ROTATE(round__V32_1__tmp10___2[1][i__49],1,32);
    }
    for (int i__510 = 0; i__510 <= 3; i__510++) {
      state__[2][i__510] = L_ROTATE(round__V32_1__tmp10_[2][((i__510 + 2) % 4)],8,32);
      state____2[2][i__510] = L_ROTATE(round__V32_1__tmp10___2[2][((i__510 + 2) % 4)],8,32);
    }
  }
  ...
  output____2[0][2] = state____2[0][2];
  output____2[0][3] = state____2[0][3];
  output____2[1][0] = state____2[1][0];
  output____2[1][1] = state____2[1][1];
  output____2[1][2] = state____2[1][2];
  output____2[1][3] = state____2[1][3];
  output____2[2][0] = state____2[2][0];
  output____2[2][1] = state____2[2][1];
  output__[2][2] = state__[2][2];
  output__[2][3] = state__[2][3];
  output____2[2][2] = state____2[2][2];
  output____2[2][3] = state____2[2][3];
