...
void AES__ (/*inputs*/ DATATYPE plain__[8],DATATYPE key__[11][8], /*outputs*/ DATATYPE cipher__[8]) {
  ...
  for (int i = 1; i <= 9; i++) {
    SubBytes__(tmp__[(i - 1)][0],tmp__[(i - 1)][1],tmp__[(i - 1)][2],tmp__[(i - 1)][3],tmp__[(i - 1)][4],tmp__[(i - 1)][5],tmp__[(i - 1)][6],tmp__[(i - 1)][7],&_tmp70_[0],&_tmp70_[1],&_tmp70_[2],&_tmp70_[3],&_tmp70_[4],&_tmp70_[5],&_tmp70_[6],&_tmp70_[7]);
    for (int i1 = 0; i1 <= 7; i1++) {
      _tmp71_[i1] = PERMUT_16(_tmp70_[i1],0,5,10,15,4,9,14,3,8,13,2,7,12,1,6,11);
    }
  ...
  SubBytes__(tmp__[9][0],tmp__[9][1],tmp__[9][2],tmp__[9][3],tmp__[9][4],tmp__[9][5],tmp__[9][6],tmp__[9][7],&_tmp73_[0],&_tmp73_[1],&_tmp73_[2],&_tmp73_[3],&_tmp73_[4],&_tmp73_[5],&_tmp73_[6],&_tmp73_[7]);
  for (int i2 = 0; i2 <= 7; i2++) {
    _tmp74_[i2] = PERMUT_16(_tmp73_[i2],0,5,10,15,4,9,14,3,8,13,2,7,12,1,6,11);
  }
