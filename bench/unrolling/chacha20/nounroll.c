...
void Chacha20__ (/*inputs*/ DATATYPE plain__[16], /*outputs*/ DATATYPE cipher__[16]) {
  ...
  DATATYPE state__[11][16];

  // Instructions (body)
  state__[0][0] = plain__[0];
  state__[0][4] = plain__[4];
  state__[0][12] = plain__[12];
  state__[0][8] = plain__[8];
  state__[0][1] = plain__[1];
  state__[0][5] = plain__[5];
  state__[0][13] = plain__[13];
  state__[0][9] = plain__[9];
  state__[0][2] = plain__[2];
  state__[0][6] = plain__[6];
  state__[0][14] = plain__[14];
  state__[0][10] = plain__[10];
  state__[0][3] = plain__[3];
  state__[0][7] = plain__[7];
  state__[0][15] = plain__[15];
  state__[0][11] = plain__[11];
  for (int i = 1; i <= 10; i++) {
    DR___1_DR_start___1_QR___1__tmp5_[0] = ADD(state__[(i - 1)][0],state__[(i - 1)][4],32);
    DR___1_DR_start___1_QR___1_QR_start___1__tmp1_ = XOR(state__[(i - 1)][12],DR___1_DR_start___1_QR___1__tmp5_[0]);
    DR___1_DR_start___1_QR___1__tmp5_[3] = L_ROTATE(DR___1_DR_start___1_QR___1_QR_start___1__tmp1_,16,32);
    DR___1_DR_start___1_QR___1__tmp5_[2] = ADD(state__[(i - 1)][8],DR___1_DR_start___1_QR___1__tmp5_[3],32);
    DR___1_DR_start___1_QR___1_QR_start___1__tmp2_ = XOR(state__[(i - 1)][4],DR___1_DR_start___1_QR___1__tmp5_[2]);
    ...
    DR___1_DR_start___1_QR___2__tmp5_[0] = ADD(state__[(i - 1)][1],state__[(i - 1)][5],32);
    DR___1_DR_start___1_QR___2_QR_start___1__tmp1_ = XOR(state__[(i - 1)][13],DR___1_DR_start___1_QR___2__tmp5_[0]);
    DR___1_DR_start___1_QR___2__tmp5_[3] = L_ROTATE(DR___1_DR_start___1_QR___2_QR_start___1__tmp1_,16,32);
    DR___1_DR_start___1_QR___2__tmp5_[2] = ADD(state__[(i - 1)][9],DR___1_DR_start___1_QR___2__tmp5_[3],32);
    DR___1_DR_start___1_QR___2_QR_start___1__tmp2_ = XOR(state__[(i - 1)][5],DR___1_DR_start___1_QR___2__tmp5_[2]);
    ...
    DR___1_DR_start___1_QR___3__tmp5_[0] = ADD(state__[(i - 1)][2],state__[(i - 1)][6],32);
    DR___1_DR_start___1_QR___3_QR_start___1__tmp1_ = XOR(state__[(i - 1)][14],DR___1_DR_start___1_QR___3__tmp5_[0]);
    DR___1_DR_start___1_QR___3__tmp5_[3] = L_ROTATE(DR___1_DR_start___1_QR___3_QR_start___1__tmp1_,16,32);
    DR___1_DR_start___1_QR___3__tmp5_[2] = ADD(state__[(i - 1)][10],DR___1_DR_start___1_QR___3__tmp5_[3],32);
    DR___1_DR_start___1_QR___3_QR_start___1__tmp2_ = XOR(state__[(i - 1)][6],DR___1_DR_start___1_QR___3__tmp5_[2]);
    ...
    DR___1_DR_start___1_QR___4__tmp5_[0] = ADD(state__[(i - 1)][3],state__[(i - 1)][7],32);
    DR___1_DR_start___1_QR___4_QR_start___1__tmp1_ = XOR(state__[(i - 1)][15],DR___1_DR_start___1_QR___4__tmp5_[0]);
    DR___1_DR_start___1_QR___4__tmp5_[3] = L_ROTATE(DR___1_DR_start___1_QR___4_QR_start___1__tmp1_,16,32);
    DR___1_DR_start___1_QR___4__tmp5_[2] = ADD(state__[(i - 1)][11],DR___1_DR_start___1_QR___4__tmp5_[3],32);
    DR___1_DR_start___1_QR___4_QR_start___1__tmp2_ = XOR(state__[(i - 1)][7],DR___1_DR_start___1_QR___4__tmp5_[2]);
    ...
    state__[i][0] = ADD(DR___1_DR_end___1_QR___1__tmp5_[0],DR___1_DR_end___1_QR___1__tmp5_[1],32);
    DR___1_DR_end___1_QR___1_QR_end___1__tmp3_ = XOR(DR___1_DR_end___1_QR___1__tmp5_[3],state__[i][0]);
    state__[i][15] = L_ROTATE(DR___1_DR_end___1_QR___1_QR_end___1__tmp3_,8,32);
    state__[i][10] = ADD(DR___1_DR_end___1_QR___1__tmp5_[2],state__[i][15],32);
    DR___1_DR_end___1_QR___1_QR_end___1__tmp4_ = XOR(DR___1_DR_end___1_QR___1__tmp5_[1],state__[i][10]);
    state__[i][5] = L_ROTATE(DR___1_DR_end___1_QR___1_QR_end___1__tmp4_,7,32);
    ...
    state__[i][1] = ADD(DR___1_DR_end___1_QR___2__tmp5_[0],DR___1_DR_end___1_QR___2__tmp5_[1],32);
    DR___1_DR_end___1_QR___2_QR_end___1__tmp3_ = XOR(DR___1_DR_end___1_QR___2__tmp5_[3],state__[i][1]);
    state__[i][12] = L_ROTATE(DR___1_DR_end___1_QR___2_QR_end___1__tmp3_,8,32);
    state__[i][11] = ADD(DR___1_DR_end___1_QR___2__tmp5_[2],state__[i][12],32);
    DR___1_DR_end___1_QR___2_QR_end___1__tmp4_ = XOR(DR___1_DR_end___1_QR___2__tmp5_[1],state__[i][11]);
    state__[i][6] = L_ROTATE(DR___1_DR_end___1_QR___2_QR_end___1__tmp4_,7,32);
    ...
    state__[i][2] = ADD(DR___1_DR_end___1_QR___3__tmp5_[0],DR___1_DR_end___1_QR___3__tmp5_[1],32);
    DR___1_DR_end___1_QR___3_QR_end___1__tmp3_ = XOR(DR___1_DR_end___1_QR___3__tmp5_[3],state__[i][2]);
    state__[i][13] = L_ROTATE(DR___1_DR_end___1_QR___3_QR_end___1__tmp3_,8,32);
    state__[i][8] = ADD(DR___1_DR_end___1_QR___3__tmp5_[2],state__[i][13],32);
    DR___1_DR_end___1_QR___3_QR_end___1__tmp4_ = XOR(DR___1_DR_end___1_QR___3__tmp5_[1],state__[i][8]);
    state__[i][7] = L_ROTATE(DR___1_DR_end___1_QR___3_QR_end___1__tmp4_,7,32);
    ...
    state__[i][3] = ADD(DR___1_DR_end___1_QR___4__tmp5_[0],DR___1_DR_end___1_QR___4__tmp5_[1],32);
    DR___1_DR_end___1_QR___4_QR_end___1__tmp3_ = XOR(DR___1_DR_end___1_QR___4__tmp5_[3],state__[i][3]);
    state__[i][14] = L_ROTATE(DR___1_DR_end___1_QR___4_QR_end___1__tmp3_,8,32);
    state__[i][9] = ADD(DR___1_DR_end___1_QR___4__tmp5_[2],state__[i][14],32);
    DR___1_DR_end___1_QR___4_QR_end___1__tmp4_ = XOR(DR___1_DR_end___1_QR___4__tmp5_[1],state__[i][9]);
    state__[i][4] = L_ROTATE(DR___1_DR_end___1_QR___4_QR_end___1__tmp4_,7,32);
  }
  cipher__[0] = state__[10][0];
  cipher__[1] = state__[10][1];
  cipher__[2] = state__[10][2];
  cipher__[3] = state__[10][3];
  cipher__[4] = state__[10][4];
  cipher__[5] = state__[10][5];
  cipher__[6] = state__[10][6];
  cipher__[7] = state__[10][7];
  cipher__[8] = state__[10][8];
  cipher__[9] = state__[10][9];
  cipher__[10] = state__[10][10];
  cipher__[11] = state__[10][11];
  cipher__[12] = state__[10][12];
  cipher__[13] = state__[10][13];
  cipher__[14] = state__[10][14];
  cipher__[15] = state__[10][15];
