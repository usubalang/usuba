...
/* auxiliary functions */
void SubColumn__H16 (/*inputs*/ DATATYPE a0,DATATYPE a1,DATATYPE a2,DATATYPE a3, /*outputs*/ DATATYPE* b0,DATATYPE* b1,DATATYPE* b2,DATATYPE* b3) {
...
void Rectangle__ (/*inputs*/ DATATYPE plain__[4],uint16_t key__[26][4], /*outputs*/ DATATYPE cipher__[4]) {
  ...
  for (int i__ = 0; i__ <= 24; i__++) {
    ...
    SubColumn__H16(_tmp1_[0],_tmp1_[1],_tmp1_[2],_tmp1_[3],&_tmp2_[0],&_tmp2_[1],&_tmp2_[2],&_tmp2_[3]);
    tmp__[0] = _tmp2_[0];
