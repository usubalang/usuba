...
/* main function */
void MixColumn__ (/*inputs*/ DATATYPE a__[8], /*outputs*/ DATATYPE b__[8]) {
  ...
  // Instructions (body)
  RL32__(a__[0],&_tmp1_);
  _tmp2_ = XOR(a__[0],_tmp1_);
  RL32__(a__[7],&_tmp3_);
  _tmp6_ = XOR(a__[7],_tmp3_);
  RL64__(_tmp6_,&_tmp7_);
  RL32__(a__[6],&_tmp13_);
  _tmp16_ = XOR(a__[6],_tmp13_);
  RL64__(_tmp16_,&_tmp17_);
  RL32__(a__[5],&_tmp20_);
  _tmp23_ = XOR(a__[5],_tmp20_);
  RL64__(_tmp23_,&_tmp24_);
  RL32__(a__[4],&_tmp30_);
  _tmp33_ = XOR(a__[4],_tmp30_);
  RL64__(_tmp33_,&_tmp34_);
  RL32__(a__[3],&_tmp40_);
  _tmp43_ = XOR(a__[3],_tmp40_);
  RL64__(_tmp43_,&_tmp44_);
  RL32__(a__[2],&_tmp47_);
  _tmp50_ = XOR(a__[2],_tmp47_);
  RL64__(_tmp50_,&_tmp51_);
  RL32__(a__[1],&_tmp54_);
  _tmp57_ = XOR(a__[1],_tmp54_);
  RL64__(_tmp57_,&_tmp58_);
  RL64__(_tmp2_,&_tmp65_);
  _tmp4_ = XOR(_tmp2_,_tmp3_);
  b__[7] = XOR(_tmp4_,_tmp7_);
  _tmp12_ = XOR(_tmp6_,_tmp2_);
  _tmp14_ = XOR(_tmp12_,_tmp13_);
  b__[6] = XOR(_tmp14_,_tmp17_);
  _tmp21_ = XOR(_tmp16_,_tmp20_);
  b__[5] = XOR(_tmp21_,_tmp24_);
  _tmp29_ = XOR(_tmp23_,_tmp2_);
  _tmp31_ = XOR(_tmp29_,_tmp30_);
  b__[4] = XOR(_tmp31_,_tmp34_);
  _tmp39_ = XOR(_tmp33_,_tmp2_);
  _tmp41_ = XOR(_tmp39_,_tmp40_);
  b__[3] = XOR(_tmp41_,_tmp44_);
  _tmp48_ = XOR(_tmp43_,_tmp47_);
  b__[2] = XOR(_tmp48_,_tmp51_);
  _tmp55_ = XOR(_tmp50_,_tmp54_);
  b__[1] = XOR(_tmp55_,_tmp58_);
  _tmp62_ = XOR(_tmp57_,_tmp1_);
  b__[0] = XOR(_tmp62_,_tmp65_);
