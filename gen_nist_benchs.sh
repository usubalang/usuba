...
# Photon bitslice
./usubac -gen-bench -light-inline -bits-per-reg 32 -B -no-sched -o nist/photon/usuba/bench/photon_ua_bitslice.c -arch std -no-share nist/photon/usuba/ua/photon_bitslice.ua
...
./usubac -gen-bench -light-inline -bits-per-reg 32 -no-sched -B -o nist/clyde/usuba/bench/clyde_ua_bitslice.c nist/clyde/usuba/ua/clyde_bitslice.ua
# Clyde (spook) vslice
...
# Xoodoo bitslice
./usubac -gen-bench -light-inline -bits-per-reg 32 -no-sched -B -o nist/xoodoo/usuba/bench/xoodoo_ua_bitslice.c nist/xoodoo/usuba/ua/xoodoo.ua
# Xoodoo vslice
./usubac -gen-bench -light-inline -no-sched -V -o nist/xoodoo/usuba/bench/xoodoo_ua_vslice.c nist/xoodoo/usuba/ua/xoodoo.ua
