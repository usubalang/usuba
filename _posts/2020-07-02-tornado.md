...
Bilan:
 ...
 - m less loops (m/2 outer, m/2 inner) (m = MASKING_ORDER)
 - m/2 * 10 less memory accesses because of registers
 - m/2 * 3 less memory accesses (because of merged inner loops)
